    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='video.Cate', verbose_name='视频分类')),
            ],
            options={
                'verbose_name': '视频',
        ...
        migrations.AddField(
            model_name='set',
            name='video',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='video.Video', verbose_name='视频名称'),
        ),
        migrations.AddField(
            model_name='likes',
            name='video',
